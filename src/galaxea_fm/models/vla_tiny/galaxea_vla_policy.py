...
from .galaxea_vla import GalaxeaVLA
...
class GalaxeaVLAPolicy(BasePolicy):
    def __init__(
        self,
        ...
        **model_cfg: DictConfig,
        ...
        self.model = GalaxeaVLA(model_cfg)
        ...
        # FIXME(junlin): enable load pretrained vlm
        self.model.load_pretrained_weights()
        self.model.tie_action_proprio_weights()
        # self.model.freeze_unused_weights() # for vla tiny, we use all features in vlm
