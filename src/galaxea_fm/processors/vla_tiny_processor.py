...
class VLATinyProcessor(BaseProcessor):
    def __init__(
        self,
        ...
        global_image_token_index: int,
        fake_token_around_image_token_index: int,
        ...
        self.global_image_token_index = global_image_token_index
        self.fake_token_around_image_token_index = fake_token_around_image_token_index
        ...
        self.total_image_tokens = self.num_input_images * (num_image_tokens_per_camera + 3)
    ...
    def _prompt_images(self) -> List[int]:
        ...
        ] + [self.image_token_index] * self.num_image_tokens_per_camera + [self.fake_token_around_image_token_index]
    ...
    def tokenize_instruction(self, instruction: str | List[str]) -> torch.Tensor:
        ...
        # [batch_size, max_image_text_tokens]
        input_ids = torch.cat([text_input_ids[:, :3], image_input_ids, text_input_ids[:, 3:]], dim=1)
