...
@dataclass
class Exp_SigLIP_224px_Debug(VLAConfig):
    vla_id: str = "siglip-224px+debug+g1"
    base_vlm: Union[str, Path] = "siglip-224px+7b"
    ...
    # Data Mixture Parameters
    data_mix: str = "berkeley_cable_routing"
    shuffle_buffer_size: int = 56_000
...
@dataclass
class Exp_Galaxea0_224px_Debug(VLAConfig):
    vla_id: str = "glx-224px+debug+g1"
    base_vlm: Union[str, Path] = "paligemma2-3b-pt-224"
...
@dataclass
class Exp_SigLIP_224px_Debug8(Exp_SigLIP_224px_Debug):
    vla_id: str = "siglip-224px+debug+g8"
...
class VLARegistry(Enum):
    ...
    # Debug Configuration
    SIGLIP_224PX_DEBUG = Exp_SigLIP_224px_Debug
    SIGLIP_224PX_DEBUG8 = Exp_SigLIP_224px_Debug8
    
    GLX_224PX_DEBUG = Exp_Galaxea0_224px_Debug
