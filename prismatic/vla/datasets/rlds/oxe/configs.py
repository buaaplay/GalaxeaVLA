...
OXE_DATASET_CONFIGS = {
    ...
    "bridgev2_depth_intrinsics": {  # our generated bridge with depth
        "image_obs_keys": {"primary": "image_0", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": "depth_0", "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", None, "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    },
    ...
    "libero_spatial_no_noops": {
        ...
        "state_encoding": StateEncoding.POS_EULER,
        # changed from ["EEF_state", None, "gripper_state"] as oxe requires that state only can have 8 dims.
        "action_encoding": ActionEncoding.EEF_POS,
    },
    ...
    "libero_spatial_no_noops_depth_intrinsics": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "depth", "secondary": None, "wrist": "wrist_depth"},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    "libero_object_no_noops_depth_intrinsics": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "depth", "secondary": None, "wrist": "wrist_depth"},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    "libero_goal_no_noops_depth_intrinsics": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "depth", "secondary": None, "wrist": "wrist_depth"},
        "state_obs_keys": ["EEF_state", "gripper_state"],
        # changed from ["EEF_state", None, "gripper_state"] as oxe requires that state only can have 8 dims.
    ...
    "libero_10_no_noops_depth_intrinsics": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": "depth", "secondary": None, "wrist": "wrist_depth"},
        "state_obs_keys": ["EEF_state", "gripper_state"], 
        # changed from ["EEF_state", None, "gripper_state"] as oxe requires that state only can have 8 dims.
    ...
    ### galaxea datasets v1
    "galaxea_v2": {
        "image_obs_keys": {"head": "image_camera_head", "wrist_left": "image_camera_wrist_left", "wrist_right": "image_camera_wrist_right"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None}, # not using for now, but available
        "state_obs_keys": ["ee_pose_left", "gripper_state_left", "ee_pose_right", "gripper_state_right"],
        "state_encoding": None, # not used by rlds
        "action_encoding": ActionEncoding.ABS_EEF_POS_BIMANUAL, # new action encoding for bimanual control
    },
    ### galaxea-r1 datasets
    "galaxea_r1" : {
        "image_obs_keys": {"head": "image_camera_head", "wrist_left": "image_camera_wrist_left", "wrist_right": "image_camera_wrist_right"},
        "depth_obs_keys": {"head": "depth_camera_head", "wrist_left": "depth_camera_wrist_left", "wrist_right": "depth_camera_wrist_right"}, 
        "state_obs_keys": ["ee_pose_left", "gripper_state_left", "ee_pose_right", "gripper_state_right"],
        "state_encoding": None, # not used by rlds
        "action_encoding": ActionEncoding.ABS_EEF_POS_BIMANUAL, # new action encoding for bimanual control
    },
    "galaxea_r1_lite_jointvel" : {
        "image_obs_keys": {"head": "image_camera_head", "wrist_left": "image_camera_wrist_left", "wrist_right": "image_camera_wrist_right"},
        "depth_obs_keys": {"head": "depth_camera_head", "wrist_left": "depth_camera_wrist_left", "wrist_right": "depth_camera_wrist_right"}, 
        "state_obs_keys": ["joint_position_arm_left", 
        ...
        "state_encoding": None, # not used by rlds
        "action_encoding": ActionEncoding.R1_LITE, 
    },
    "galaxea_r1_lite" : {
        "image_obs_keys": {"head": "image_camera_head", "wrist_left": "image_camera_wrist_left", "wrist_right": "image_camera_wrist_right"},
        "depth_obs_keys": {"head": "depth_camera_head", "wrist_left": "depth_camera_wrist_left", "wrist_right": "depth_camera_wrist_right"}, 
